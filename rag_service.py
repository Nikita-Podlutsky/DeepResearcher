...
from scraper import process_search_tasks_with_content_extraction
...
# --- Конфигурация ---
OLLAMA_LLM_MODEL = os.getenv("OLLAMA_LLM_MODEL", "gemma3:latest") # Модель для генерации текста
...
CHUNK_SIZE = 1000 # Размер чанка (фрагмента текста)
CHUNK_OVERLAP = 150 # Перекрытие между чанками
TOP_K_RESULTS = 3 # Количество извлекаемых релевантных чанков из БД
...
def run_research(topic: str) -> str:
    ...
    if all_search_tasks:
        ...
        try:
            ...
            scraped_results = process_search_tasks_with_content_extraction(
                                all_search_tasks,
...
if __name__ == '__main__':
    ...
    test_topic = "русско японская война"
